				...
				<div className="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
							...
							<Tab.List className="grid grid-cols-4 gap-6">
								{data.space[0].images.map((img) => (
									...
									>
										{({ selected }) => (
											<>
												<span className="sr-only">{img.id}</span>
					...
					<div className="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
						...
						<div className="mt-3">
							...
							<p className="text-3xl text-gray-900">{data.space[0].price}</p>
						</div>
						...
						<div className="mt-6">
							...
							<div
								...
								dangerouslySetInnerHTML={{ __html: data.space[0].information }}
							/>
						</div>
						...
						<form className="mt-6">
							...
							<div className="mt-10 flex sm:flex-col1">
								<button
									type="submit"
									className="max-w-xs flex-1 bg-yellow-400 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-yellow-600 sm:w-full"
								>
									Rent this space
								</button>
											...
											<>
												<h3>
													<Disclosure.Button className="group relative w-full py-6 flex justify-between items-center text-left">
														<span
															className={classNames(
																open ? 'text-yellow-400' : 'text-gray-900',
																'text-sm font-medium'
															)}
														>
															{detail.name}
