...
const ImageUploadButton = (props) => {
	...
	return (
		<div>
			{filesToUpload === 0 && (
				<button
					class='bg-yellow-400 text-white border-2font-bold py-2 px-4 rounded hover:bg-yellow-400 focus:outline-none'
					onClick={handleClick}
				>
					Upload
				</button>
			...
			{filesToUpload > 0 && (
				<button class='bg-green-500 text-white border-2 border-green-500 font-bold py-2 px-4 rounded focus:outline-none cursor-not-allowed'>
							...
							>
								<section class='h-full overflow-auto p-8 w-full flex flex-col'>
									<header class='border-dashed border-2 border-gray-400 py-12 flex flex-col justify-center items-center'>
										...
										<button
											...
											class='mt-2 rounded-md px-4 py-2 bg-green-200 hover:bg-green-300 focus:shadow-outline focus:outline-none'
										>
											Select a file
										</button>
									</header>
								...
								<footer class='flex justify-end px-8 pb-8 pt-4'>
									<button
										...
										class='rounded-md px-4 py-2 bg-green-400 hover:bg-green-700 text-white focus:shadow-outline focus:outline-none'
									>
										Upload Now
									</button>
									<button
